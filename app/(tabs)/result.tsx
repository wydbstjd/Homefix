...
export default function ResultScreen() {
  ...
  useEffect(() => {
    console.log("📺 유튜브 데이터 받음:", youtube_videos);
    if (youtube_videos && typeof youtube_videos === "string" && youtube_videos.trim() !== "") {
      try {
        const parsed = JSON.parse(youtube_videos);
        console.log("📺 파싱된 유튜브 데이터:", parsed);
        setYoutubeVideos(Array.isArray(parsed) ? parsed : []);
      } catch (e) {
        console.error("📺 유튜브 데이터 파싱 실패:", e);
        setYoutubeVideos([]);
      }
    } else {
      setYoutubeVideos([]);
                ...
                {youtubeVideos.map((video, idx) => (
                  ...
                  >
                    {video.thumbnailUrl ? (
                      ...
                      >
                        <Text style={styles.youtubePlaceholder}>📺</Text>
                      </View>
                    )}
